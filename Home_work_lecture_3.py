...
# мучался над этой задачей,ибо метод isdigit() не распознает знак минус, пришлось делить код на две части
# мне не нравится как сильно похожи обе части кода, но по-другому я сделать не смог(
